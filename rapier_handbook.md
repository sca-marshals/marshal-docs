...
1.1) Kingdoms have the option of including sliding the edge of the blade by pushing (push cut) and/or placing the tip of the blade upon and then drawing it across an opponent (tip cut) as valid blows.
1.2) Cut and thrust rapier also includes the use of percussive cuts as a valid blow.  Percussive cuts must always be delivered with sufficient control so as not to injure the opponent while still delivering the necessary impact for a valid cut.
...
#### ACKNOWLEDGEMENT OF BLOWS
 ...
 tested at the marshal’s discretion; all other materials must be tested the first time new gear
 ...
 ii.
 Daggers may also be used but care must be taken not to punch or strike the fighter
 ...
 brief overview:
 Clamp the fabric over the 3" flange, balance the guide tube over the center of the fabric, and
